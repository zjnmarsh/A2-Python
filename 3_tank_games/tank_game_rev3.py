...
print("Press board to see your hitboard")
...
while x > 0:
    location = str(input("Player 1, enter coordinates to destroy player 2's tanks"))
    if location == "board":
        for i in range(7):
    ...
    location = str(input("Player 2, enter coordinates to destroy player 1's tanks"))
    if location == "board":
        for i in range(7):
