...
def read_png_chunks(filename):
    with open(filename, 'rb') as png_file:
        ...
        while True:
            ...
            length = int.from_bytes(png_file.read(4), byteorder='big', signed=False)
            ...
            crc = int.from_bytes(png_file.read(4), byteorder='big', signed=False)
            # Check crc
...
read_png_chunks('Color-PNG-Image-Transparent-Background.png')
