...
class Game:
    ...
    def __init__(self, startingRoomID):
        ...
        self.commandDict = {'n': self.move, 's': self.move, 'e': self.move, 'w': self.move,
                            'jump': self.jump, 'look': self.look_room}

    def get_current_room(self):
        # self.roomDict[self._currentRoomID]
        # print(self.roomDict)
        # print(self._currentRoomID)
        # print(self.roomDict[self._currentRoomID])
    ...
    def look_room(self, commands='', arguments=''):
